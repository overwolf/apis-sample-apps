const
  ...
  HOST = 'social-login-sample-server.overwolf.com', // replace with 'localhost:3002' when running a local server
  API_URL = `${PROTOCOL}://${HOST}/google`,
  WS_URL = `${WS_PROTOCOL}://${HOST}/google`;
...
//    message with their Google user info. Now the user is logged in, and can make
...
async function getUser() {
  ...
  console.log('getUser(): getting Google user');
